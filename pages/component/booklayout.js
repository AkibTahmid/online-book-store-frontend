            ...
            <div className='p-28'>
                ...
                <div className="mx-auto w-72 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="flex flex-col items-center pb-10">
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-400">{props.author}</span>
                        <span className="text-sm text-gray-500 dark:text-gray-400">{props.category}</span>
                        <span className="text-sm text-gray-500 dark:text-gray-400">{props.price}</span>
