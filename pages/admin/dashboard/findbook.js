...
export async function getServerSideProps({ query }) {
    ...
    try {
        const response = await axios.get('http://localhost:3000/admin/book/findbook/' + inputValue);
        ...
        return {
            props: {
                data: { status: "enter valid book id" }
            }
        };
    }
}