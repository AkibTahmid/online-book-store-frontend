...
import BookLayout from '@/pages/component/booklayout';
...
export async function getServerSideProps({ query }) {
    ...
    try {
        const response = await axios.get('http://localhost:3000/admin/employee/findemployee/' + inputValue);
        ...
        return {
            props: {
                data: { status: "enter valid employee id" }
            }
        };
    }
}